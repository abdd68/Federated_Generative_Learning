...
def parse_args(input_args=None):
    ...
    parser.add_argument('--data_path_train', default="/codespace/imagenet1000/train", type=str, help='data path for train')
    parser.add_argument('--data_path_test', default="/codespace/imagenet1000/val", type=str, help='data path for test')
    parser.add_argument('--com_round', type=int, default=5, help="number of rounds of training")
    ...
    parser.add_argument(
        ...
        default=500,
        help=(
            "Save a checkpoint of the training state every X updates. These checkpoints can be used as final."
        ),
    )
    parser.add_argument(
